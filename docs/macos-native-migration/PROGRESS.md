...
Read `PLAN.md`, run `git status --short --branch -uall`, inspect the last five commits, then activate only ready `M7-W2`. M6-W1 is complete in `d3f319c494a61d559643964a6253a3ec8c495df3`; M6-W2 is complete in `467bb275e04a087e00a4dd85365273bdcf130185`; M6-W3 is complete in `789502d804528d39098fd21fd227d4572ae18040`; M6-W4 is complete in `891138f6ea639c3af718d74e8f63f65e74650cf6`; M6-W5 is complete in `ebcccb3761bbfdbf66d042e75dae85ace9450823`; M6-W6 is complete in `ed31c77fbedcacfcd5e691d0f67ab08c25dff9e4`; and M6-W7 is complete in `a0c6456c1`. M6-W7's fixture-only scenario evidence, cancellation suppression, and authoritative external-snapshot handling must not be reopened. M7-W1 is the completed source-backed settings matrix above; next activate only `M7-W2`, preserve its non-secret/temporary-root boundary, and retain all existing bridge, fixture-root, Bundle ID, and no-launch constraints.
