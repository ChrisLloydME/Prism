...
Read `PLAN.md`, run `git status --short --branch -uall`, inspect the last five commits, then activate only ready `M6-W5`. M6-W1 is complete in `d3f319c494a61d559643964a6253a3ec8c495df3`; M6-W2 is complete in `467bb275e04a087e00a4dd85365273bdcf130185`; M6-W3 is complete in `789502d804528d39098fd21fd227d4572ae18040`; M6-W4 is complete in `891138f6ea639c3af718d74e8f63f65e74650cf6` and may not be reopened. M6-W5 may implement only native worlds, servers, screenshots, and logs plus their explicit cancellation/recovery contracts; preserve the existing facade/bridge ownership and temporary-fixture safety contracts. Do not begin M6-W6 or later work until M6-W5 evidence is verified and committed.
